  ...
  <div class="space-y-6">
    ...
    <div class="bg-surface border border-outline-variant/30 p-6 rounded-lg" style="background-color: var(--surface-color);">
      ...
      <form id="support-form" onsubmit="submitSupportTicket(event)" class="space-y-4">
        ...
        <button type="submit" class="w-full py-3 bg-primary-color text-on-primary font-display font-bold uppercase tracking-wider text-xs rounded hover:bg-emerald-400 hover:box-glow transition-all active:scale-95">Transmit Ticket Payload</button>
      </form>
    </div>
  </div>
</div>`;
